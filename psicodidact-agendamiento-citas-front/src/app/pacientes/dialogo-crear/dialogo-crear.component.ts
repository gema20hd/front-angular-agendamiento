...
this.btn_opcion="Editar";
  ...
  this.pacienteService.obtenerPacienteById(this.infoEditar.idPaciente).subscribe((paciente) =>{ 
  ...
  */
   ...
   // this.dialogForm.controls['tipoEmpleo'].setValue(this.pacienteEditar.trabajo?.tipoTrabajo);
    ...
    if (this.pacienteEditar.estadoPaciente==='ACTIVO') {
          ...
          representante.discapacidad=discapacidadCreada;
              ...
              //  trabajo.idTrabajo=25;
                ...
                //    representante.idRepresentante=43;
                    ...
                    representante.estadoRepresentante='ACTIVO';
             ...
             //   trabajo.idTrabajo=25;
                ...
                .subscribe(
                  ...
                  if (trabajoCreado.idTrabajo) {
                    ...
                    representante.estadoRepresentante='INACTIVO';
             ...
             pacienteCreado => {
               ...
               if (pacienteCreado) {
                 ...
                 if (pacienteCreado) {
                  ...
                  this.dialogRefCrear.close(pacienteCreado.identificacionPaciente);
       ...
       console.log('DISCAPACIDAD EDITADO iuuuuuuuuuu'+discapacidadEditada.porcetajeDiscapacidad);
        if (discapacidadEditada.idDiscapacidad) {
          ...
          this.representanteREditar.discapacidad=discapacidadEditada;
                ...
                this.representanteREditar.estadoRepresentante='ACTIVO';
             ...
             this.trabajoEditar.direccionTrabajo="";
                ...
                .subscribe(
                  ...
                  if (trabajoCreado.idTrabajo) {
                    ...
                    this.representanteREditar.estadoRepresentante='INACTIVO';
        ...
        console.log("el estado -----------"+this.pacientePacienteEditar.estadoPaciente);
          ...
          if (this.pacienteActivoRadio==1) {
            console.log("INHRESA-----------------------1");
             ...
             this.pacientePacienteEditar.estadoPaciente='ACTIVO';
            ...
            // this.pacientePacienteEditar.estadoPaciente=true;
              ...
              if (this.pacienteActivoRadio==2) {
                ...
                this.pacientePacienteEditar.estadoPaciente='INACTIVO';
             ...
             pacienteEditado => {
               ...
               if (pacienteEditado) {
                 ...
                 if (pacienteEditado) {
                  ...
                  this.dialogForm.reset();
                  this.dialogRefCrear.close(pacienteEditado.identificacionPaciente);
